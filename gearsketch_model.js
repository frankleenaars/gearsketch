...
(function() {
  ...
  Board = (function() {
    ...
    Board.prototype.restoreBoard = function(board) {
      var gear, id, _ref;
      _ref = this.gears;
      for (id in _ref) {
        if (!__hasProp.call(_ref, id)) continue;
    ...
    Board.prototype.restoreBoardAfterDemo = function(board) {
